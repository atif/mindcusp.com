  ...
  const services = [
    {
      ...
      image: <IconSourceCode className="w-8 h-8 text-primary-500" />,
    },
    {
      ...
      image: <IconBinaryTree2 className="w-8 h-8 text-primary-500" />,
    },
    {
      ...
      image: <IconAnalyze className="w-8 h-8 text-primary-500" />,
    },
    {
      title: "Partnership",
      description:
        "Our team possesses extensive expertise in establishing software developer teams from scratch, dedicated to delivering high-quality code while adhering to industry best practices. Partner with us to bring your next innovation to life!",
      image: <IconHeartHandshake className="w-8 h-8 text-primary-500" />,
    },
  ];
